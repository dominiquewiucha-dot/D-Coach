...
assert(html.includes("app.js?v=pwa-v84"), "index app cache buster must be pwa-v84");
assert(html.includes("styles.css?v=pwa-v84"), "index style cache buster must be pwa-v84");
