...
assert(app.includes('const BACKUP_FORMAT_VERSION = "6.16.0";'), "backup format version missing");
...
assert(html.includes("app.js?v=pwa-v67"), "index app cache buster must be pwa-v67");
assert(html.includes("styles.css?v=pwa-v67"), "index style cache buster must be pwa-v67");
