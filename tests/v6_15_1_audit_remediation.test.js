...
assert(html.includes("app.js?v=pwa-v83"), "index app cache buster must be pwa-v83");
assert(html.includes("styles.css?v=pwa-v83"), "index style cache buster must be pwa-v83");
