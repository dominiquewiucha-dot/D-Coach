...
assert(app.includes('const BACKUP_FORMAT_VERSION = "6.15.1";'), "backup format version missing");
...
assert(app.includes('const APP_VERSION = "pwa-v66";'), "app version must be pwa-v66");
assert(sw.includes('const CACHE_NAME = "dcoach-pwa-v66";'), "service worker cache must be pwa-v66");
assert(html.includes("app.js?v=pwa-v66"), "index app cache buster must be pwa-v66");
assert(html.includes("styles.css?v=pwa-v66"), "index style cache buster must be pwa-v66");
